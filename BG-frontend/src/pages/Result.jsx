  ...
  return (
    <div className="mx-4 my-3 lg:mx-44 min-h-[75vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">
          <div>
            ...
            <img className="rounded-md border" src={image ? URL.createObjectURL(image) : 'null'} alt="image" />
          </div>
      ...
      {resultImage && <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
        <a href={resultImage} download className="px-8 py-2.5 text-white text-sm bg-linear-to-r from-blue-600 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700">Download Image</a>
      </div>}
